Public Class White
    ...
    Private Sub f3PictureBox4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PictureBox4.Click
        sender.borderstyle = BorderStyle.Fixed3D
        Me.Finalize()
    End Sub


    Private Sub f3PictureBox2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PictureBox2.Click
        sender.borderstyle = BorderStyle.Fixed3D
        Me.Finalize()
    End Sub
